...
def get_capabilities():
    ...
    greeting = "Hello, thank you for contacting Mastercard Support. My name is Tracy, your virtual assistant. I'll first verify your identity. I'm securely sending a text message to the number on your account now…"
